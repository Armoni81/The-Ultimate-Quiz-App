...
export default function Movies() {
  const questions1 = [
    {
      questionsText:
        "Taraji P. Henson portrays a betrayed woman in what 2018 film?",
      anwserOptions: [
    ...
    },
    {
      ...
      anwserOptions: [
        {
          anwserText: "Whistle While You Twurk- Ying Yang Twinz",
          isCorrect: false,
        },
    ...
    {
      questionsText:
        "What is the highest-grossing animated film in movie history?",
      anwserOptions: [
    ...
    {
      questionsText:
        "Which Pixar movie featured a journey to South America in a house held up by floating balloons?",
      anwserOptions: [
