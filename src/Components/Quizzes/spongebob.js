...
export default function Spongebob() {
  const questions1 = [
    ...
    {
      questionsText:
        'What does SpongeBob and Patrick use to drown their sorrows in "The SpongeBob SquarePants Movie" ?',
      anwserOptions: [
    ...
    {
      questionsText:
        "What do Mermaid Man and Barnacle Boy use to get from place to place?",
      anwserOptions: [
