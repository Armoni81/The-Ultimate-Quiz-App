...
export default function COR() {
  const questions1 = [
    ...
    {
      questionsText:
        "Which of the following Job Training courses are taught at COR?",
      anwserOptions: [
    ...
    {
      questionsText:
        " What year was the warehouse property doneted to COR in downtown Atlanta?",
      anwserOptions: [
...

    {
      ...
      anwserOptions: [
        {
          anwserText:
            "Fund designed to admit students into a COR learning program",
          isCorrect: false,
        },
        {
          anwserText:
            "Fund designed to provide transportation for children 17 and up to highschool or university",
          isCorrect: false,
        },
        {
          anwserText:
            " Assistance Fund designed to provide financial assistance to minority students choosing to attend college, university, or technical school upon graduation from high school.",
          isCorrect: true,
        },
    ...
    {
      questionsText:
        " What Organization partners with COR to deliver Software Development training?",
      anwserOptions: [
