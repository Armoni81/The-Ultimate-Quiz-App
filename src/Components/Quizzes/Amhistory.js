...
export default function History() {
  const questions1 = [
    {
      questionsText:
        "Juneteenth, which became an official federal holiday in 2021, commemorates...",
      anwserOptions: [
        {
          anwserText: "The signing into law of the Civil Rights Act of 1964.",
          isCorrect: false,
        },
        {
          anwserText:
...

    {
      ...
      anwserOptions: [
        ...
        {
          anwserText: "SCLC-Southern Christian Leadership Conference",
          isCorrect: false,
        },
        { anwserText: "CORE-Congress of Racial Equality", isCorrect: true },
        {
          anwserText: "SNCC-Student Nonviolent Coordinating Committee",
          isCorrect: false,
        },
      ],
    },
    ...
    {
      questionsText:
        "Before he was elected president of the United States, Barack Obama served as a U.S. senator of which state?",
      anwserOptions: [
    ...
    {
      questionsText:
        "Rev. Jesse L. Jackson is known for his leadership roles with which civil rights organizations?",
      anwserOptions: [
        {
          anwserText: "Southern Christian Leadership Conference",
          isCorrect: false,
        },
        {
          anwserText: "People United to Save Humanity (Operation PUSH)",
          isCorrect: false,
        },
      ...
      {showScore ? (
        <div className="quiz-cont">
          <div id="container-quest">
            <p id="question" className="positionscore">
              You scored {score} out of {questions1.length}
            </p>
            <p id="question" className="positionscore-1">
              {percentage}%
            </p>

            <button onClick={resetQuiz} id="tryAgainBtn">
              Try again 👀
            </button>
        ...
        <div className="quiz-cont">
          <div id={isShowing ? "container-quest" : "hide"}>
            ...
            <div className={isShowing ? "btn-grid" : "btn-grid2"}>
              {questions1[currentQuestion].anwserOptions.map(
                (anwserOptions) => (
                  <button
                    onClick={() =>
                      handleAnswerButtonClick(anwserOptions.isCorrect)
                    }
                    className="btnz"
                  >
            ...
            <div className="controls-quest"></div>
            <div>
