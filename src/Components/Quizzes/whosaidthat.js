...
export default function Whosaidthat() {
  const questions1 = [
    {
      questionsText:
        " Who said, \"100% of the shots you don't take don't go in\"?",
      anwserOptions: [
    ...
    {
      questionsText:
        'Who said, "From there to here, and here to there, funny things are everywhere"?',
      anwserOptions: [
    ...
    {
      questionsText:
        'Who said, "A lie gets halfway around the world before the truth has a chance to get its pants on"?',
      anwserOptions: [
    ...
    {
      questionsText:
        'Who said, "We didn\'t lose the game; we just ran out of time"?',
      anwserOptions: [
    ...
    {
      questionsText:
        ' What movie character in Sandlot said "Your killing me smalls"?',
      anwserOptions: [
